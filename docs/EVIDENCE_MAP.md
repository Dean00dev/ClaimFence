...
Starting in v0.6, a claim may instead opt into a repository-wide stable value with
`<!-- claimfence-id: ... -->`. The ledger records that value as `stable_id`, and the
Evidence Map shows it beside the deterministic machine identifier. See
[Stable Claim Anchors](CLAIM_ANCHORS.md).
...
steps:
  ...
  - uses: actions/attest@1e69f48acb82d1966a394da916b4c1698aa569d6 # v4.2.2
    with:
      ...
      predicate-type: https://raw.githubusercontent.com/Dean00dev/ClaimFence/v0.6.0/schema/claim-ledger-v1.schema.json
...
Scanned Markdown and comparison ledgers are untrusted input. Under v0.6.0's packaged scan
...
v0.6.0 code and tests, not modified forks or future releases.
